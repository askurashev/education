               ...
               dom: 'PBfrtip',
                ...
                searchBuilderType: 'array'
                    ...
                    },
					{
                        ...
                        visible: false,
						orderable: false,
						render: function(d) {return '<div style="margin-top:0.5em;font-size:0.9em">[^' + d.ID + ']: ' + d.Author + ' ' + d.Title + '. ' + d.Year + '.' + d.Files.map(x => '<span style="margin-left: 0.5em;">[' + x + '](https://education.kurashev.com/environmental-data/files/' + x + ')</span>') + '</div>';}
                    }
                ],

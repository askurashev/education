    ...
    var table = $('#data').DataTable({
        ...
        columns: [{
            ...
            },
            {
                ...
                orderable: false,
                render: function(d) {
                    return '<div class="cardheader">' + d.Type + ' · ' + d.Lang + ' · ' + d.Year + ' · ' + d.Author + '</div><div class="cardtitle">' + d.Title + '</div><div class="cardabstract">' + d.Abstract + '</div><div style="clear:both"></div><div style="margin-top:1em;font-size:0.9em"><svg style="width:14px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#818181" d="M345 39.1L472.8 168.4c52.4 53 52.4 138.2 0 191.2L360.8 472.9c-9.3 9.4-24.5 9.5-33.9 .2s-9.5-24.5-.2-33.9L438.6 325.9c33.9-34.3 33.9-89.4 0-123.7L310.9 72.9c-9.3-9.4-9.2-24.6 .2-33.9s24.6-9.2 33.9 .2zM0 229.5V80C0 53.5 21.5 32 48 32H197.5c17 0 33.3 6.7 45.3 18.7l168 168c25 25 25 65.5 0 90.5L277.3 442.7c-25 25-65.5 25-90.5 0l-168-168C6.7 262.7 0 246.5 0 229.5zM144 144c0-17.7-14.3-32-32-32s-32 14.3-32 32s14.3 32 32 32s32-14.3 32-32z"/></svg>' + d.Tags.map(x => '<span style="font-size:0.9em;margin-left: 0.5em;color: #212529;background-color: #eceeef;padding-right: 0.6em;padding-left: 0.6em;border-radius: 10rem;" class="badge badge-pill badge-light">' + x + '</span>').join('') + '</div><div style="margin-top:0.5em;font-size:0.9em"><svg  style="width: 11px;margin-left: 3px;margin-top: -3px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="#818181" d="M0 64C0 28.7 28.7 0 64 0H224V128c0 17.7 14.3 32 32 32H384V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V64zm384 64H256V0L384 128z"/></svg>' + d.Files.map(x => '<span style="margin-left: 0.5em;">' + x + '</span>') + '</div>';
                }
            },
            {
                data: null,
                ...
                orderable: false,
                render: function(d) {
                    return '<div style="margin-top:0.5em;font-size:0.9em">[^' + d.ID + ']: ' + d.Author + ' ' + d.Title + '. ' + d.Year + '.' + d.Files.map(x => '<span style="margin-left: 0.5em;">[' + x + '](https://education.kurashev.com/environmental-data/files/' + x + ')</span>') + '</div>';
                }
            }
        ],
    ...
    var table = $('#lawsinternational').DataTable({
                ...
                config: {
                    preDefined: {
                        criteria: [{
                            ...
                            origData: 'Type',
                            type: 'string',
                            value: ['Международное законодательство']
                        }],
                        logic: 'AND'
                    }
                }
        ...
        columns: [{
            ...
            },
            {
                ...
                orderable: false,
                render: function(d) {
                    return '<div class="cardtags namelist line"><div class="tagtitle">Теги</div><p>' + d.Tags.join('</p><p>') + '</p></div><div class="cardtags namelist line"><div class="tagtitle">Файлы</div><p>' + d.Files.join('</p><p>') + '</p></div>';
                }
            }
        ]
    });
                ...
                config: {
                    preDefined: {
                        criteria: [{
                            ...
                            origData: 'Type',
                            type: 'string',
                            value: ['Российское законодательство']
                        }],
                        logic: 'AND'
                    }
                }
                ...
                config: {
                    preDefined: {
                        criteria: [{
                            ...
                            origData: 'Type',
                            type: 'string',
                            value: ['Советское законодательство']
                        }],
                        logic: 'AND'
                    }
                }
                ...
                config: {
                    preDefined: {
                        criteria: [{
                            ...
                            origData: 'Type',
                            type: 'string',
                            value: ['Дореволюционное законодательство']
                        }],
                        logic: 'AND'
                    }
                }
